...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2019 at 09:56 PM
...
CREATE TABLE `agencies` (
  ...
  `AgencyAddress` varchar(50) DEFAULT NULL,
  `AgencyCity` varchar(50) DEFAULT NULL,
  `AgencyProv` varchar(50) DEFAULT NULL,
  `AgencyPostal` varchar(50) DEFAULT NULL,
  `AgencyCountry` varchar(50) DEFAULT NULL,
  `AgencyPhone` varchar(50) DEFAULT NULL,
  `AgencyFax` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `agencies` (`AgencyId`, `AgencyAddress`, `AgencyCity`, `AgencyProv`, `AgencyPostal`, `AgencyCountry`, `AgencyPhone`, `AgencyFax`) VALUES
...
(64, 'is', 'w', 'it', '(403) 382-2981', 'new.se@travelexperts.com', 'Intermediate Agent', 2),
(65, 'oh', 'L', 'no', '(403) 727-2929', 'oh.no@travel.com', 'Intermediate Agent', 1);
...
(1, 'Caribbean New Year', '2019-05-01 00:00:00', '2019-07-17 00:00:00', 'Cruise the Caribbean & Celebrate the New Year.', '4800.0000', '400.0000'),
(2, 'Polynesian Paradise', '2016-12-12 00:00:00', '2019-05-01 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000'),
(3, 'Asian Expedition', '2016-05-14 00:00:00', '2016-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000'),
(4, 'European Vacation', '2019-03-20 00:00:00', '2019-06-01 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000');
...
--
ALTER TABLE `agents`
  MODIFY `AgentId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
